package andrew.deng.javautiltest;
...
public class JavaEnumMapExample {
	...
	public static void main(String[] args) {
		...
		System.out
				.println("*** Checking for concurrent modification exception! ***");
